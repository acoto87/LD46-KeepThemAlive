...
enum NVGalign textAlignToNVGalign(TextAlignment align)
{
    switch (align)
    {
        case TEXT_ALIGN_LEFT:   return NVG_ALIGN_LEFT;
        case TEXT_ALIGN_CENTER: return NVG_ALIGN_CENTER;
        case TEXT_ALIGN_RIGHT:  return NVG_ALIGN_RIGHT;
        case TEXT_ALIGN_TOP:    return NVG_ALIGN_TOP;
        case TEXT_ALIGN_MIDDLE: return NVG_ALIGN_MIDDLE;
        case TEXT_ALIGN_BOTTOM: return NVG_ALIGN_BOTTOM;
        default:
        {
...
enum NVGwrap textWrappingToNVGwrap(TextWrapping wrap)
{
    switch (wrap)
    {
        case TEXT_WRAP_NONE: return NVG_WRAP_NONE;
        case TEXT_WRAP_CHAR: return NVG_WRAP_WORD;
        default:
        {
...
enum NVGtrim textTrimmingToNVGtrim(TextTrimming trim)
{
    switch (trim)
    {
        case TEXT_TRIM_NONE: return NVG_TRIM_NONE;
        case TEXT_TRIM_SPACES: return NVG_TRIM_SPACES;
        case TEXT_TRIM_ALL: return NVG_TRIM_ALL;
        default:
        {
...
Sprite loadFontSprite(GameContext* context, const char* fontPath)
{
    Sprite sprite = {0};
