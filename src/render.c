...
#define NVG_BLACK_TRANSPARENT nvgRGBA(0, 0, 0, 100)
#define NVG_GRAY_TRANSPARENT nvgRGBA(128, 128, 128, 128)
#define NVG_RED_TRANSPARENT nvgRGBA(128, 0, 0, 128)
#define NVG_GREEN nvgRGBA(0, 199, 0, 255)
#define NVG_RED nvgRGBA(199, 0, 0, 255)
#define NVG_LIGHT_GREEN nvgRGBA(0, 199, 0, 99)
#define NVG_LIGHT_RED nvgRGBA(199, 0, 0, 99)
#define NVG_CYAN nvgRGBA(0, 199, 199, 255)
